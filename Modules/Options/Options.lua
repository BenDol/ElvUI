...
function OPT:AddGroup(name, func)
  if self.groups[name] then
    error("Group '"..name.."' already added!")
  end
  table.insert(self.groups, {name = name, init = func})
end
...
E:RegisterModule(OPT:GetName(), function() OPT:Initialize() end)