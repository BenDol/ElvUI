...
S:AddCallback("Skin_Character", function()
  ...
  E:EnableWheelZoom(CharacterModelFrame, 0.5)
  ...
  E:EnableWheelZoom(PetModelFrame, 0.5)
  E:EnableMouseDrag(PetModelFrame)
  ...
  E:EnableWheelZoom(CompanionModelFrame, 0.5)
  E:EnableMouseDrag(CompanionModelFrame)
